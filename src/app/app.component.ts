...
export class AppComponent {
  ...
  webFormSectionDataDefault = {
    layout: '',
    components: [{ type: 1, labelText: "Default Label Text", value: 0 }, { type: 2, linkText: "Default Link Text", urlAddress: 'https://www.google.com', value: 0 }]
  };
  ...
  webFormSectionDataCustom = {
    ...
    components: [{ type: 1, labelText: "Custom Label Text", value: 0 }, { type: 2, linkText: "Custom Link Text", urlAddress: 'https://www.google.com', value: 0 }, { type: 1, labelText: "Custom Label Text", value: 0 }, { type: 2, linkText: "Custom Link Text", urlAddress: 'https://www.google.com', value: 0 }, { type: 1, labelText: "Custom Label Text", value: 0 }, { type: 2, linkText: "Custom Link Text", urlAddress: 'https://www.google.com', value: 0 }]
  };
